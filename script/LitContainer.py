...
from Litmatool import cn_translate, id_tran_name
from script import Litmatool, LitematicaViewer
...
cmd_table = tk.Text(rootc, bg=color_map["BG"], fg=color_map["TT"], font=("Arial", 12), yscrollcommand=Csroll)
