...
Block_pos : list[tuple[tuple,str]] = [] #[(pos,id),...]
...
if __name__ == "__main__":
    ...
    frame_new_title = tk.Label(frame_spawn_new, text="生成图形投影", font=("Arial", 18), bg=color_map["MC"], fg=color_map["TT"])
    frame_new_title.grid(row=0, column=0, padx=5, pady=5, columnspan=4)
    # -- ID 输入框
    label_id = tk.Label(frame_spawn_new, text="方块ID", font=("Arial", 12), bg=color_map["MC"], fg=color_map["TT"])
    label_id.grid(row=1, column=0, padx=5, pady=5)
    entry_id = tk.Entry(frame_spawn_new, width=20, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_id.grid(row=1, column=1, padx=5, pady=5, columnspan=3)
    # -- XYZ 长宽高输入框
    label_xyz = tk.Label(frame_spawn_new, text="原点XYZ", font=("Arial", 12), bg=color_map["MC"], fg=color_map["TT"])
    label_xyz.grid(row=2, column=0, padx=5, pady=5)
    label_lwh = tk.Label(frame_spawn_new, text="宽高长Size", font=("Arial", 12), bg=color_map["MC"], fg=color_map["TT"])
    label_lwh.grid(row=3, column=0, padx=5, pady=5)
    entry_x = tk.Entry(frame_spawn_new, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_x.grid(row=2, column=1, padx=2, pady=5)
    entry_y = tk.Entry(frame_spawn_new, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_y.grid(row=2, column=2, padx=2, pady=5)
    entry_z = tk.Entry(frame_spawn_new, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_z.grid(row=2, column=3, padx=2, pady=5)
    entry_length = tk.Entry(frame_spawn_new, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_length.grid(row=3, column=3, padx=2, pady=5)
    entry_width = tk.Entry(frame_spawn_new, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    ...
    check_hollow = tk.Checkbutton(frame_spawn_new, text="空心Hollow", variable=chollow, bg=color_map["MC"], fg=color_map["TT"], font=("Arial", 10))
    ...
    check_up = tk.Checkbutton(frame_spawn_new, text="上U", bg=color_map["MC"], fg=color_map["TT"], font=("Arial", 10), variable=cu)
    check_up.grid(row=5, column=1, padx=2, pady=2)
    check_down = tk.Checkbutton(frame_spawn_new, text="下D", bg=color_map["MC"], fg=color_map["TT"], font=("Arial", 10), variable=cd)
    check_down.grid(row=5, column=2, padx=2, pady=2)
    check_left = tk.Checkbutton(frame_spawn_new, text="左L", bg=color_map["MC"], fg=color_map["TT"], font=("Arial", 10), variable=cl)
    check_left.grid(row=5, column=3, padx=2, pady=2)
    check_right = tk.Checkbutton(frame_spawn_new, text="右R", bg=color_map["MC"], fg=color_map["TT"], font=("Arial", 10), variable=cr)
    ...
    entry_spawn = tk.Entry(frame_spawn_new, width=20, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    ...
    frame_change_title = tk.Label(frame_spawn_change, text="替换特定方块", font=("Arial", 18), bg=color_map["MC"],fg=color_map["TT"])
    frame_change_title.grid(row=0, column=0, padx=5, pady=20, columnspan=4)

    # -- Limit 标签和 XYZ 输入框
    label_min = tk.Label(frame_spawn_change, text="最小限制\nMinimize\nLimit XYZ", font=("Arial", 12), bg=color_map["MC"], fg=color_map["TT"])
    label_min.grid(row=1, column=0, padx=5, pady=5)
    entry_min_x = tk.Entry(frame_spawn_change, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_min_x.grid(row=1, column=1, padx=2, pady=5)
    entry_min_y = tk.Entry(frame_spawn_change, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_min_y.grid(row=1, column=2, padx=2, pady=5)
    entry_min_z = tk.Entry(frame_spawn_change, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    ...
    entry_max_x = tk.Entry(frame_spawn_change, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_max_x.grid(row=2, column=1, padx=2, pady=5)
    entry_max_y = tk.Entry(frame_spawn_change, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_max_y.grid(row=2, column=2, padx=2, pady=5)
    entry_max_z = tk.Entry(frame_spawn_change, width=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    entry_max_z.grid(row=2, column=3, padx=2, pady=5)

    # -- Change 标签和多行输入框
    label_change = tk.Label(frame_spawn_change, text="替换表\nChange", font=("Arial", 12), bg=color_map["MC"], fg=color_map["TT"])
    label_change.grid(row=3, column=0, padx=5, pady=5)
    text_change = tk.Text(frame_spawn_change,width=20, height=5, bg=color_map["BG"], fg=color_map["PC"], font=("Arial", 10))
    text_change.grid(row=3, column=1, columnspan=3, padx=5, pady=5)

    label_spawn2 = tk.Label(frame_spawn_change, text="文件名File", font=("Arial", 12), bg=color_map["MC"], fg=color_map["TT"])
    ...
    table_sty = ttk.Style()
    table_sty.configure("Treeview", font=("Arial", 12), rowheight=25, background=color_map["PC"], foreground=color_map["BG"])
